<template>
  <div class="images_list_container">
    <div class="table_header">
      ...
      <el-button type="success" size="mini" @click="showImagesDialog" v-if="isShowAdd">添加素材</el-button>
    </div>
    <div class="images_list">
      <el-row>
        <el-col :xs="12" :sm="6" :md="6" :lg="4" v-for="(item,index) in imagesList" :key="index" class="farther_box">
          <el-image
            style="width: 100px; height: 100px"
            :src="item.url"
            @click.native="selected = index">
          </el-image>
          <div class="selected" v-if="selected === index && isImagesShow"></div>
          <div class="operation_image">
            ...
            <i v-if="isShowAdd" class="el-icon-delete-solid" @click="removeImage(item.id)"></i>
          </div>
        </el-col>
      </el-row>
    </div>
...
.selected {
    ...
    top: 0;
     ...
     left: 0;
     right: 0;
    background: url('./choose.jpg') no-repeat;
